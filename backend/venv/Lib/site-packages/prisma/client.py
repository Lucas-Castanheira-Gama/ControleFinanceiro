...
SCHEMA_PATH = Path('C:/Users/lucat/Documents/controle de gastos pessoais/backend/app/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\lucat\\Documents\\controle de gastos pessoais\\backend\\app\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/lucat/Documents/controle de gastos pessoais/backend/app/prisma/schema.prisma',
        }
