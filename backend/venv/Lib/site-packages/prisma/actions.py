...
class DocumentActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 Document records ordered by the id field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Document record ordered by the valor field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Document record ordered by the descricao field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Document records by creatdat values
        # and count how many records are in each group
